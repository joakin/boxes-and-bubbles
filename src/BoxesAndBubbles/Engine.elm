...
collisionBoxBox ( pos0, extents0 ) ( pos1, extents1 ) =
    let
        ...
        ( ox, oy ) =
            minus (plus extents0 extents1) (abs2 dist)
...
collision body0 body1 =
    case ( body0.shape, body1.shape ) of
        ...
        ( Bubble bubble, Box box ) ->
            let
                res =
                    collisionBoxBubble ( body1.pos, box ) ( body0.pos, bubble )
...
update gravity force body =
    let
        ...
        acceleration =
            mul2 force body.inverseMass

        -- f = ma => a = f/m
        velocityNew =
            plus accelGravity <| plus body.velocity acceleration
